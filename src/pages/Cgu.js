...
const Cgu = () => {
  return (
    <div style={{ padding: "150px" }}>
        <h2>Conditions générales d'utilisation des sites web</h2>
        <br />
     

Informations et mentions légales
Propriété du site ; acceptation des conditions d'utilisation

Les présentes conditions générales d'utilisation (les « Conditions d'utilisation ») s'appliquent au site web d'Apple sis à l'adresse www.apple.com et à tous les sites associés liés au site www.apple.com par Apple, ses filiales et sociétés affiliées, dans le monde entier (collectivement désignés par le terme le « Site »). Le Site est la propriété d'Apple Inc. (« Apple ») et de ses concédants. EN UTILISANT LE SITE, VOUS ACCEPTEZ LES PRÉSENTES CONDITIONS D'UTILISATION ; SI VOUS NE LES ACCEPTEZ PAS, VEUILLEZ NE PAS UTILISER LE SITE.
...
Sauf mention expresse figurant dans les présentes Conditions d'utilisation, aucune section du Site ni aucun Contenu ne peuvent être copiés, reproduits, republiés, téléchargés, publiés, exposés en public, encodés, traduits, transmis ou diffusés de quelque façon que ce soit (y compris par « écriture miroir ») sur un autre ordinateur, serveur, site web ou support de publication ou de diffusion, ou pour quelque entreprise commerciale que ce soit, sans l'accord écrit préalable d'Apple.
...
Vous vous engagez à ne prendre aucune mesure qui imposerait une charge excessive ou déraisonnable sur l'infrastructure du Site ou des systèmes ou des réseaux d'Apple, ou de tout système ou réseau connecté au Site ou à Apple.
...
Vous ne devez pas essayer de contrefaire les en-têtes ou manipuler les identifiants de quelque manière que ce soit pour déguiser l'origine d'un message ou d'une transmission envoyé à Apple sur ou via le Site, ou d'un service offert sur ou via le Site. Vous ne devez pas prétendre être ou représenter quelqu'un d'autre, ni vous faire passer pour une autre entité physique ou morale.

Vous ne devez pas utiliser le Site ou son Contenu dans un dessein illicite ou prohibé par les présentes Conditions d'utilisation, ni en vue d'encourager toute activité illégale ou autre portant atteinte aux droits d'Apple ou de tiers.
Achats ; autres conditions générales

Des conditions générales annexes pourront s'appliquer à des achats de biens ou de services, ainsi qu'à des sections ou fonctionnalités spécifiques du Site, notamment les concours, promotions et autres offres similaires, lesdites conditions étant intégrées aux présentes Conditions d'utilisation à titre de référence. Vous acceptez de vous conformer à ces conditions générales annexes, en confirmant notamment le cas échéant avoir l'âge légal requis pour utiliser ou participer au service ou à l'offre concerné. En cas de contradiction entre les présentes Conditions d'utilisation et les conditions publiées pour, ou applicables à une section spécifique du Site ou pour un service offert sur ou via le Site, ces dernières conditions prévaudront et régiront l'utilisation de cette section du Site ou de ce service spécifique.

Le cas échéant, les obligations d'Apple vis-à-vis de ses produits et services sont régies uniquement par les conventions aux termes desquelles elles ont été définies et aucun élément figurant sur ce Site ne saurait être interprété de façon à modifier ces conventions.

Apple pourra apporter des changements aux produits et services offerts sur le Site ou aux prix applicables à ces produits et services à tout moment et sans préavis. Les informations publiées sur le Site concernant des produits et des services peuvent être obsolètes, et Apple ne s'engage nullement à mettre à jour les informations publiées sur le Site relatives à ces produits et services.

Les conditions générales ci-après concernent et régissent également l'utilisation du Site, et sont incorporées ici à titre de référence :

    Informations relatives aux marques commerciales
    Informations relatives aux droits d'auteur
    Droits et autorisations
    Actions en violation de droits d'auteur
    Lutte contre le piratage
    Signaler un acte de piratage
    Politique d'Apple en matière de soumission d'idées non sollicitées
    Informations sur les licences de logiciels
    Contacts juridiques

Les règles et politiques énoncées pourront être modifiées de temps en temps et seront applicables dès la publication de ces modifications sur le Site.
Comptes, mots de passe et sécurité

Certains services et fonctionnalités offerts sur ou via le Site peuvent nécessiter l'ouverture d'un compte (y compris la configuration d'un identifiant Apple et d'un mot de passe). Vous avez l'entière responsabilité de préserver la confidentialité des informations relatives à votre compte, notamment votre mot de passe, et de toutes les opérations effectuées sous votre compte. Vous vous engagez à prévenir Apple immédiatement en cas d'utilisation non autorisée de votre compte ou de votre mot de passe, ou de toute violation de la sécurité. Toutefois, vous pourrez être tenu pour responsable des préjudices subis par Apple ou par tout autre utilisateur ou visiteur du Site dû à l'utilisation de votre identifiant Apple, votre mot de passe ou votre compte par une autre personne.
